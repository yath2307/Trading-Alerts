...
def addToBePurchasedStocks(symbol):
    fetching_data.toBePurchasedStocksList.append(self=fetching_data, __object=symbol)
...
def removeToBePurchasedStocks(symbol):
    fetching_data.toBePurchasedStocksList.remove(self=fetching_data, __object=symbol)
...
def addPurchasedStocks(symbol):
    fetching_data.purchasedStocksList.append(self=fetching_data, __object=symbol)
